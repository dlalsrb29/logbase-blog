  ...
  return (
    <footer>
      <div className="footer-actions">
        <button className="footer-btn" onClick={() => setShowNewsletter(true)}>뉴스레터 신청하기</button>
        <button className="footer-btn" onClick={() => setShowInquiry(true)}>문의하기</button>
      </div>
      <NewsletterModal show={showNewsletter} onClose={() => setShowNewsletter(false)} />
      <InquiryForm show={showInquiry} onClose={() => setShowInquiry(false)} />
